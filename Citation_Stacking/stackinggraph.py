...
for paper in data:
    ...
    for ref in paper['references']:
        ...
        primary_author = extract_primary_author(ref)  # Extract the primary author of the cited paper
...
nx.draw_networkx_edges(G, pos, edgelist=[(u, v) for u, v, d in edges if d['color'] == 'blue'], edge_color='blue')
nx.draw_networkx_edges(G, pos, edgelist=[(u, v) for u, v, d in edges if d['color'] == 'black'], edge_color='blue')
