...
def generate_fake_author():
    ...
    "Edward", "Ronald", "Timothy", "Jason", "Jeffrey", "Ryan", "Jacob", "Ethan",
    "Alexander", "Henry", "Samuel", "Dylan", "Luke", "Gabriel", "Anthony", "Isaac",
    "Grayson", "Owen", "Julian", "Levi", "Coleman", "Everett", "Bryce",
...
def generate_fake_title():
    nouns = ["Review", "Comparison", "Exploration", "Assessment", "Examination", "Survey", "Analysis", "Research", "Investigation", "Observation", "Measurement", "Testing", "Validation", "Verification", "Application"]
    subjects = ["Quantum Mechanics", "Global Warming", "Artificial Intelligence", "Cryptography", "Biochemistry", "Molecular Biology", "Neuroscience", "Particle Physics", "Environmental Science", "Ecology", "Robotics", "Software Engineering", "Sociology", "Public Health", "Graphic Design"]
...
def generate_fake_journal():
    journals = ["Journal of Advanced Research", "International Journal of Scientific Studies", "Global Science Review"]
...
# Write the generated papers to a JSON file
with open('fake_papers.json', 'w') as f:
