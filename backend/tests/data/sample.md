...
T' T<br>EhYoo ie Bo [CR]<br>Lis (NY [oes<br>pi|| RE R<br>q'1 q2 (aligned) q2<br>Re SO0@)<br>[]  $=<br>T (aligned)<br>**----- End of picture text -----**<br>
...
**----- Start of picture text -----**<br>
Cluster Window<br>Reduction Window Selection Window<br>(c) Characterize the cluster (T2)<br>(a) Remove Duplicate  (b) Identify Families  (d) Evaluate cluster quality (T3) Scratchpad<br>Transitions &  Transitions of Transitions (T1) NE — (e) Insight provenance<br>Atomic Scalars Avg. intra-cluster distance<br>Structured Dataset<br>my TER RE R Label E with Annotations<br>TE 50<br>Original Reduced<br>**----- End of picture text -----**<br>
...
**----- Start of picture text -----**<br>
1 3 5Export ScratchpadScratchpad<br>All<br>2<br>ICO<br>rotational<br>displacements<br>i |<br>Superquadric ▼ K1 ▼ ?<br>4 -0.2 0.0 0.2<br>▼<br>**----- End of picture text -----**<br>
...
**----- Start of picture text -----**<br>
? 5 Notes<br>1 2/1 nn Fo 2 Group Displacement<br>S000C00o0Cnoa0n0EB DOCO0O0o 00000 00g | CT.<br>OEEO0000EEOOER000O000000000000000T,mimimm me | *2 6 8% & Ey“5<br>BUOINOOOOEI00ONOEOEOOOOO000OC0OCOOOO0N, | #55 Atel DR A]<br>OOEEOEOEO00O00000000000000000000G00ROEEEEFISOI00000000000000000000000000:,B0ooOEEOEEEEOEEEEN00I00000000000000600BoCooooSeaaaasanaasaasaecRenREEEB0500000000BeeOe OOna0aCaEeOoooDo COoa000000000naCoca ass aa AE)o0, || © ytPY¢ susOK ©.&9Sop.1 %4Sh  42AYoA)Lan4.<br>|80000000000 [a/v] mi000CaREOOCOoE0RNODO000CE0000000e00000000: || ©,© SeA© To Scratchpad “90  Correlation . 0.7<br>B05Hoa00000000a0COO0n00oDesEnooen |)<br>|Bess|a/0/a/a/a/a/a/s/a/s/a/s/s//n/s/e/n///e)sHEEEEEO000EE00A0I0000OOEOO0R00EE000[/0/8/n/8//n/n/a/|e/n/a]6/0/n/e/0/0/6//0/66/e)=0/0/0/s/o/0DonssmoEoEsnssssssn [///] sseseEssaEeEEsaEseeEaaaaa [mmm]] nmseanSin/0/enaan00/0/a/0//o6 neESEEonsnalityEan0/0) £55,ND 3<br>OEEEENOOEEEEINOINEEEINEEOOEEAGEEEE[a/0//0/a]0/m/n/n/|6/n/n/e|6/6/a/0/a]0/a/n]s|6/n/a/)0/n/a)s)m8000000000 clo a J| 4%EES<br>B0CoC[/0/0/a/n//n/a/a/6|6/e/8/0/6/e/0/0/0/6/e/a/6///0lsO00 B0n00on OCDOOOOGEEDRCNDO000N,. COED ASE 3? | il<br>[a/aja/nin/ala/n/a/o/a/n/n/0/e//e//a/o/e/n/0/a/0/0s 0/0/80 0) I 0]<br>| [0]3/5//m/0]5/m]]0/6)08]6/0/a]5] 0/0] 0/0] 6)6/0)n/8]0]s;8)6)6]a/n/o/o je0/0]aaA ELEOCSAUR [01il AB il fli | i alin<br>HEEEIEHEOEEEEEOI0RNIINEIONEOEEEEEE |48h 8% gl) i i36 fA<br>EOHEIIEOIINNEIINONINIONOOONEEEESOCCERCOOCOEAC | whee# | HY i Ori |<br>[jn/o/ojoja/a/n/0/e/e/e/0/slo/e/a/S|/a/a/0/n/a/e/n/a/a|r=/a/a]]e/8/a/a/0]sa/0];=/e/a/|6/a/n/0]0/0/0]0EE saCEOOODE CACA00ECDN0//e/e/0/0/o//aj oe] | CRSARNO ! | Git a alt<br>[o=mEEEHEEREEOOEEEanes)Bc ee ma EE nn HEHEEAEEREE - 4 Bt 4a i ———— a 821 | |<br>[of’ hessels 5»2, RE aEos0.93Sse ibea a 0ATsDNOJ)5S NERIAASE555% pe HiRErr  ——rT E (| 1DTE<br>eroey || ddesls ||Tle | TRY<br>Atom ▼ absAvgBonds ▼ t 0.0<br>0.0 | — 0.02 se] 0.04 Show Medoid EEaald HE fai i1dBE<br>**----- End of picture text -----**<br>


Fig. 6. _Cluster Windows_ allow for the detailed exploration of transitions automatically clustered by LAMDA ( **R1** ). The _Embedding View_ ( **1** ) displays transitions within a cluster as fully interactive 3D visualizations. Transitions are organized in a 2D grid that reflects the overall cluster hierarchy. In this figure, we include a zoomed-out overview of a grid from a large cluster and annotate it with detailed visualizations to provide an illustrative example. The _Group Displacement Visualization_ ( **2** ) provides a 3D overview of a cluster which facilitates analysis and comparisons ( **R2; R3** ). The dendrogram ( **3** ) provides interactions to navigate the local cluster hierarchy. A heatmap ( **4** ) shows distances within the selected cluster; while ( **5** ) provides support for annotations and note-taking. 

current label of the cluster; this label can be edited in the _Cluster Window_ (subsection V-E). Most importantly, clicking in either of the two overview visualizations allows analysts to explore transitions and clusters in more detail: clicking in the heatmap embeds the transitions corresponding to the clicked cell in the _Scratchpad_ (subsection V-F), while clicking branches in the dendrogram opens a _Cluster Window_ . 
...
**----- Start of picture text -----**<br>
C1 C2 C3<br>PEE ICO<br>Fast surface transformations ICO Rotational Minute deformations Slow diffusive motion<br>**----- End of picture text -----**<br>


Fig. 7. Results from the case study. The dendrograms for each coarse cluster are displayed, labeled with its index and the expert’s interpretation; note that they are not to scale. At the bottom, representative transitions for each cluster are shown, rendered with _Group Displacement_ visualizations. _C_ 1 and _C_ 3 are of particular interest, since they contain deformations that significantly alter the structure of the nanoparticle, with these two coarse clusters being separated by their mechanism of action; they either deform the surface or internally re-arrange the structure of the nanoparticle. _C_ 2 contains most of the transitions of the dataset and is comprised of low-energy transitions that cause minute deformations on the surface, partitioned by magnitude. 
