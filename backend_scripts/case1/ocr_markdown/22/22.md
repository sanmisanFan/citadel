...
- Merge multiple references into one; e. g., use [1]. Within each set of multiple references, the references should be sorted in ascending order. This LATEX/bibTEX template takes care of both the merging and the sorting automatically.
...
Figure 2: A visualization of the 1990–2016 data from, recreated based on Fig. 1 from [5] and is in the public domain.
...
Duis autem [1] 1 vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.
...
Figure 2 is a partial recreation of Fig. 1 from [5], which is in the public domain.
...
- [1] B. Forest. Electoral geography: From mapping votes to representing power. *Geography Compass*, 12(1):e12352, 2018. 2, 3
- [2] J. Hullman, X. Qiao, M. Correll, A. Kale, and M. Kay. In pursuit of error: A survey of uncertainty visualization evaluation. *IEEE Transactions on Visualization and Computer Graphics*, 25(1):903–913, 2018. 2
- [3] S. Pandey and A. Ottley. Mini-vlat: A short and effective measure of visualization literacy. *Computer Graphics Forum*, 42(3):1–11, 2023. 3
- [4] C. Stokes, V. Setlur, B. Cogley, A. Satyanarayan, and M. A. Hearst. Striking a balance: Reader takeaways and preferences when integrating text and charts. *IEEE Transactions on Visualization and Computer Graphics*, 29(1):1233–1243, 2022. 3
- [5] C. J. Tolbert and K. Mossberger. US current population survey & american community survey geographic estimates of internet use, 1997- 2014. *Harvard Dataverse*, 4, 2015. 3

<sup>1</sup>The algorithm behind Marching Cubes [4] had already been described by Wyvill et al. [3] a year earlier.