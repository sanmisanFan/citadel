...
this sorting automatically.
  ...
  - Merge multiple references into one; e. g., use [5]. Within each
...
Duis autem [5] [1] vel eum iriure dolor in hendrerit in vulputate velit
...
1 The algorithm behind Marching Cubes [1] had already been described
by Wyvill et al. [4] a year earlier.
...
[1] A. Checco, L. Bracciale, P. Loreti, S. Pinfield, and G. Bianchi. Aiassisted peer review. _Humanities and Social Sciences Communications_,
8(1):1–11, 2021. 3

[2] Chewbacca. Artificial reference paper hop-2 no.5. _Fake Journal 2_,
10(2):1–4, 2020. 2

[3] S. Shankar and R. Garcia. “we have no idea how models will behave in
production until production”: How engineers operationalize machine
learning. _Proceedings of the ACM on Human-Computer Interaction_,
8(CSCW1):1–34, 2024. 3

[4] J. P. Tennant and T. Ross-Hellauer. The limitations to our understanding
of peer review. _Research integrity and peer review_, 5(1):6, 2020. 3

[5] D. Vader. Artificial reference paper hop-2 no.4. _Fake Journal 1_,
10(2):1–4, 2023. 2, 3
