...
this sorting automatically.
  ...
  - Merge multiple references into one; e. g., use [1]. Within each
...
based on Fig. 1 from [5] and is in the public domain.
...
Duis autem [1] [1] vel eum iriure dolor in hendrerit in vulputate velit
...
by Wyvill et al. [3] a year earlier.
...
Figure 2 is a partial recreation of Fig. 1 from [5], which is in the
public domain.
...
[1] B. Forest. Electoral geography: From mapping votes to representing
power. _Geography Compass_, 12(1):e12352, 2018. 2, 3

[2] J. Hullman, X. Qiao, M. Correll, A. Kale, and M. Kay. In pursuit of
error: A survey of uncertainty visualization evaluation. _IEEE Transac-_
_tions on Visualization and Computer Graphics_, 25(1):903–913, 2018.
2

[3] S. Pandey and A. Ottley. Mini-vlat: A short and effective measure of
visualization literacy. _Computer Graphics Forum_, 42(3):1–11, 2023. 3

[4] C. Stokes, V. Setlur, B. Cogley, A. Satyanarayan, and M. A. Hearst.
Striking a balance: Reader takeaways and preferences when integrating text and charts. _IEEE Transactions on Visualization and Computer_
_Graphics_, 29(1):1233–1243, 2022. 3

[5] C. J. Tolbert and K. Mossberger. US current population survey & american community survey geographic estimates of internet use, 19972014. _Harvard Dataverse_, 4, 2015. 3
